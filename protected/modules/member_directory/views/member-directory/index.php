    ...
    <div class="member-directory-outer">
        ...
        <div class="virtual-business-card">
            <ul class="nav nav-tabs virtual-business-tab">
                <li class="active">
                    <a href="<?php echo Yii::$app->request->baseUrl . '/member_directory/member-directory' ?>">
                        <strong>Mentor view</strong>
                    </a>
                </li>
                <li>
                    <a href="<?php echo Yii::$app->request->baseUrl . '/member_directory/member-directory/mentee' ?>">
                ...
                <div id="<?php echo Yii::$app->request->baseUrl . '/index.php/member_directory/member-directory' ?>" class="tab-pane active">
                    <div class="virtual-business-card-outer active">
                        <div class="user-info">
                            ...
                            <div class="but-group">
                                <a href="<?php echo Yii::$app->request->baseUrl . '/member_directory/member-directory/profile?id=' . $userdata->user_id ?>" class="view-profile">
                                    View Profile
                                </a>
                                <a href="#">
